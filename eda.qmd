...
-   Variable objetivo: `winner_is_better_rank`, vale `1` si la ganadora tenía mejor ranking que la perdedora; `0` si ganó la jugadora peor rankeada, es decir, *upset*.
...
Antes de dibujar nada: ¿qué crees que pasará con los upsets?
¿Son igual de frecuentes en todas las superficies? ¿Influye la diferencia de ranking?
:::
...
En problemas de clasificación (Aprendizaje Supervisado, ver apartado @sec-metodosML) existe una variable de interés fundamental, es la variable respuesta o variable objetivo. 
En este ejemplo la variable objetivo es `winner_is_better_rank`:
